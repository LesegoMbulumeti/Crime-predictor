...
<div >
<button class="btn btn-outline-primary" data-bs-toggle="collapse" href="#collapseExample" role="button">Generate report </button>
</div>
...
<form action="./print_crime.php" method="post">

  <p><strong>Filter to generate a report</strong></p>
    <div class="field">
    <br>
        <label class="label">Officer</label>
       <div class="select">
          <select required style="width:100%" name="officer" >
    ...
    <br>
       ...
       <div class="select">
          <select required style="width:100%" name="location" >
          <option value="all">All</option>
        <?php 
            $sql = " SELECT * FROM location";
            $results = mysqli_query($conn, $sql);
            while($location = mysqli_fetch_assoc($results)){?>
            <option value="<?php print_r($location['location_id'])?>"><?php print_r($location['name'])?></option>
        <?php }?>
    ...
    <br>
       ...
       <div class="select">
        ...
        <?php 
            ...
            $results = mysqli_query($conn, $sql);
            while($crime = mysqli_fetch_assoc($results)){?>
            <option value="<?php print_r($crime['crime_type_id'])?>"><?php print_r($crime['crime_type'])?></option>
        <?php }?>
...
<br>
 ...
 <button type="submit" name="filter_report" class="btn btn-outline-primary" name="submit_report_info">Filter & Generate</a>
